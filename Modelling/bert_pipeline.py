# ----------------------------------------------------
# To run:
# 1. customize hyper-parameters in Section 0
# 2. in Terminal:
#       sh run_bert_pipeline.py
# ----------------------------------------------------
...
# For saving processed texts input
...
# ========= 2.a.i. Model =========
# For the first iteration, train the model on all data.
# For the rest of the iterations, load the model checkpoints and train only on new data.
if j == 2:
    ...
    # Load data. Necessary for feeding into BERT
    ...
    # Prediction model (BERT + classification layer)
    ...
    # Load tokenizer and model from the previous checkpoint
