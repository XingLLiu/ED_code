...
<br>- modify clean_extract_notes.sh to have your UMLS license username and password and the absolute path locations storing the annotatorInput and annotatorOutput folders (should be in ED_code)
